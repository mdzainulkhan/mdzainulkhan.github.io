...
const exp = [
  {
    ...
    loc: 'Delhi NCR',
    current: true,
    pts: ['Designed and developed 15+ responsive business websites from scratch using HTML5, CSS3, and JavaScript for international clients, including Modul-Pack GmbH (Germany), an industrial packaging company, later converting the codebase to WordPress for client content management.',

      'Built and shipped production-ready personal projects, including IndiaResultLive.com and AllConvertHub.com, with API-driven pages, dynamic routing, SEO-friendly structure, and optimized frontend performance.',
      'Improved project structure, component reusability, metadata setup, page loading speed, and responsive UI quality across personal and freelance frontend projects',
      'Strengthened hands-on frontend architecture skills including React Hooks, state management, lazy loading, code splitting, reusable component design, and Core Web Vitals optimization.',
  ...
  },
  {
    ...
    pts: [
      ...
      'Improved frontend performance using lazy loading, code splitting, and component-level optimization.',
