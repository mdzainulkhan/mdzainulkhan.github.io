...
const projects = [
  ...
  {
    name:'INTELLISPINE',
    sub:'Clinic Management System',
    url:null,
    live:false,
    score:null,
    desc:'Clinic & patient management frontend with reusable components, real-time REST API data, and mobile-first design for smooth clinical operations.',
    tags:['React.js','Next.js','Tailwind CSS','REST APIs','JavaScript'],
    pts:['Patient & clinic management UI','Reusable component library','REST API for real-time data','Mobile-first & cross-browser','Optimized React architecture'],
